   ...
   <div class="site-section">
     <div class="container">
       <div class="section-title">
             <h2>Aranan: {{ $route.params.keyword }}</h2>
           </div>
       <div class="row">
         <div v-for="n in news" class="col-lg-6">
           <div class="post-entry-2 d-flex">
             ...
             <div class="contents">
               ...
               <p class="mb-3">{{n.description}} //content & description & image bilgisi yok</p>
               <div class="post-meta">
                 <span class="d-block"><a href="#">{{n.author}}</a></span>
...
onMounted(()=>{
 axios.get("https://newsapi.org/v2/top-headlines?country=tr&q="+route.params.keyword+"&apiKey="+process.env.VUE_APP_NEWSAPIKEY)
 .then((obj)=>{
...
const nextNews = (e) => {
  axios
    .get(
      "https://newsapi.org/v2/top-headlines?country=tr&q="+route.params.keyword+"&page=" +
        e +
        "&apiKey=" +
