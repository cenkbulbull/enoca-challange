<template>
  ...
  onMounted(() => {
    axios
      .get(
        "https://newsapi.org/v2/top-headlines?country=tr&category=entertainment&page=1&apiKey=" +
  ...
  const nextNews = (e) => {
    axios
      .get(
        "https://newsapi.org/v2/top-headlines?country=tr&category=entertainment&page=" +
          e +
          "&apiKey=" +
          process.env.VUE_APP_NEWSAPIKEY
      )
